...
const Developers = () => {
  ...
  const snippet3 = `<a class="dbuzz-share-button" href="${webIntentUrl}" ` +
                    'data-text="Hello dbuzz" data-size="large" data-hashtags="dbuzz,hive" '+
                    'data-url="https://d.buzz" data-min-chars="50">Buzz</a>'
                ...
                <div className={classes.hero}>
                  ...
                  <div>
                    <iframe id="dbuzz-widget-0"
                      ...
                      src={hostUrl + "/widgets/buzz_button.html#id=dbuzz-widget-1&size=m&text=Hello world&url=" + hostUrl + "&tags=dbuzz,hive&origin_app_name=D.buzz&min_chars=50"}></iframe>
                  </div>
                  <div >
                    <h5>
                      Web Intent Url
                    ...
                    <ul>
                      ...
                      <li>
                        <p>The <b>min_chars</b> parameter is the minimum number of characters required to buzz. If not set, no minimum character limit is required.</p>
                      </li>
                    </ul>
                    <br />
                    <h5>
