        ...
        <Row>
          ...
          <Col xs={8}>
            <div>
              ...
              <section className="section" id="section-20">
                <div className={classes.hero}>
                  <div >
                    <h2>DISCLAIMER</h2>
                  </div>
              ...
              <section className="section" id="section-21">
                <div className={classes.hero}>
                  <div >
              ...
              <section className="section" id="section-22">
                <div className={classes.hero}>
                  <div >
              ...
              <section className="section" id="section-23">
                <div className={classes.hero}>
                  <div >
                    <h2>USER DATA</h2>
                  </div>
              ...
              <section className="section" id="section-24">
                <div className={classes.hero}>
                  <div >
              ...
              <section className="section" id="section-25">
                <div className={classes.hero}>
                  <div >
              ...
              <section className="section" id="section-26">
                <div className={classes.hero}>
                  <div >
                    <h2>MISCELLANEOUS</h2>
                  </div>
              ...
              <section className="section" id="section-27">
                <div className={classes.hero}>
                  <div >
                    <h2>CONTACT US</h2>
                  </div>
